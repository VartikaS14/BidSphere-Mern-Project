...
export const Hero = () => {
  return (
    <>
      <section className="hero bg-primary py-0">
        <Container className="flex items-center justify-between md:flex-row flex-col">
          <div className="w-full md:w-1/2 text-white pr-12">
            ...
            <Body className="leading-7 text-gray-200 my-5">
          ...
          <div className="w-full md:w-1/2 my-16 relative py-12">
            ...
            <div className="horiz-move absolute md:top-32 top-8 left-0">
              <Box title="Proof of quality" desc="Lorem Ipsum Dolar Amet" />
            </div>
            <div className="horiz-move absolute bottom-72 -right-24">
              <Box title="Safe and secure" desc="Lorem Ipsum Dolar Amet" />
            </div>

            <div className="px-5 py-2 bg-white shadow-md flex items-center gap-5 rounded-xl ml-5 -mt-16 vert-move w-1/2">
    ...
    <>
      <form className="">
        ...
        <div className="relative">
          ...
          <input type="search" id="default-search" className="block shadow-md w-full p-3 ps-12 text-sm text-gray-800 rounded-full bg-gray-50 outline-none" placeholder="Search product..." />
          <PrimaryButton className="absolute end-2.5 bottom-2 px-6 py-0.5 text-base top-1">Search</PrimaryButton>
        </div>
      </form>
    </>
  );
...
const Box = ({ title, desc }) => {
  return (
    <>
      <div className="px-5 py-2 bg-white shadow-md flex items-center gap-5 rounded-xl w-auto">
        <div className="w-12 h-12 bg-green_100 flex items-center justify-center rounded-full">
